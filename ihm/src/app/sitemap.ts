...
const STATIC_ROUTES: { path: string; priority: number; changefreq: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/components', priority: 0.8, changefreq: 'weekly' },
  ...
  { path: '/minerals', priority: 0.7, changefreq: 'weekly' },
  { path: '/crafting', priority: 0.7, changefreq: 'weekly' },
  { path: '/blueprints', priority: 0.7, changefreq: 'weekly' },
